...
Two middleware functions are provided by default in the `noiseparticles.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `noiseparticles.handler` namespace to manage the enabled middleware.
